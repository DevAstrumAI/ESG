  ...
  useEffect(() => {
    const loadScope1Data = async () => {
      ...
      try {
        ...
        let url = `${API_URL}/api/emissions/scope1?year=${year}&month=${encodeURIComponent(selectedMonth)}`;
      ...
      <div className="scope1-page">
        ...
        <AddOtherLocationDialog
          ...
          onSubmit={(loc) => {
            ...
            setShowSummary(false);
            setCurrentStep(0);
            navigate(`/scope1?month=${encodeURIComponent(selectedMonth)}`);
          }}
        />
        <style jsx>{`
          .scope1-page { padding: 24px; max-width: 1400px; margin: 0 auto; }
  ...
  return (
    <div className="scope1-page">
      ...
      <style jsx>{`
        ...
        .page-header h1 { font-size: 28px; font-weight: 700; color: #1B4D3E; margin: 0 0 8px; }
        .page-header p { color: #6B7280; margin: 0; }
        .scope1-card { background: white; border-radius: 12px; border: 1px solid #E5E7EB; overflow: visible; }
